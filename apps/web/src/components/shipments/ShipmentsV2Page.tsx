...
export function ShipmentsV2Page() {
  ...
  if (!finalIsAuthenticated) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Требуется авторизация</h2>
          <p className="text-gray-600 mb-4">Для просмотра отгрузок необходимо войти в систему</p>
          <button 
